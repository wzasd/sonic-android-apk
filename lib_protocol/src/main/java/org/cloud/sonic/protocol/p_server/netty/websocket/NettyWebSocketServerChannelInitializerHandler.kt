...
import org.cloud.sonic.protocol.p_client.netty.websocket.NettyWebSocketClientReadHandler
import org.cloud.sonic.protocol.p_server.netty.websocket.NettyWebSocketServerReadHandler
import org.cloud.sonic.protocol.p_server.netty.websocket.NettyWebSocketServer
 ...
 *  description :
 */
class NettyWebSocketServerChannelInitializerHandler(private val server: NettyWebSocketServer): ChannelInitializer<Channel>() {
    override fun initChannel(ch: Channel?) {
        ...
        ch?.pipeline()?.addLast(NettyWebSocketServerReadHandler(server));
    }
}